function [ Belonging, Centers, Dist ] = MicrolensBelonging(M,N, LensletGridModel)
%MICROLENSBELONGING
...
%RHexaI = [1, -1/sqrt(3); 0, 2/sqrt(3)];%conversion from orthogonal to hexagonal (60 deg shearing of the vertical axis).
