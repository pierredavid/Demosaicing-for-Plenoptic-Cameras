...
% modified by Pierre David : 15 May 2017
...
DecodeOptions = LFDefaultField( 'DecodeOptions', 'WeightedDemosaic', true ); %P. DAVID: By default, the demosaicing step is now done with my method
...
LensletImage = max(0, min(LensletImage,1));

if(DecodeOptions.WeightedDemosaic || DecodeOptions.WeightedInterp)
% P. DAVID: Computation of the lenslet centors and the lenslet mask
...
%{
%Display with image with centers
